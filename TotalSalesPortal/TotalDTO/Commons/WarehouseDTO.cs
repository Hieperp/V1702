...
{
    /// <summary>
    /// NOTES: THIS IWarehouseBaseDTO AND ITS CLASS WarehouseBaseDTO IS USED TO REPRESENT OF FOREIGN RELATIONSHIP OF SalesOrders/ DeliveryAdvices/ GoodsIssues TO Wareshouses
    /// AT CURRENT: IN THE DATABASE DESIGN: THE RELATIONSHIP IS MANDATORY (MEANS: THE FOREIGN KEY WarehouseID IN THESES TABLE SalesOrders/ DeliveryAdvices/ GoodsIssues ARE REQUIRED - NOT ALLOW NULL)
    /// BUT AT DTO LAYER: WE STILL KEEP:     Nullable<int> WarehouseID
    /// THE TRUST IS THAT: THE WarehouseID IN THESE TABLES SalesOrders/ DeliveryAdvices/ GoodsIssues IS NOT VERY IMPORTANT. WE CAN ALLOW WarehouseID NULLABLE

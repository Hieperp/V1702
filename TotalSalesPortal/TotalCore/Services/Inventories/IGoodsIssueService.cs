...
namespace TotalCore.Services.Inventories
{
    ...
    {
        ICollection<GoodsIssueViewDetail> GetGoodsIssueViewDetails(int goodsIssueID, int locationID, int deliveryAdviceID, int customerID, int receiverID, string shippingAddress, decimal? vatPercent, bool isReadOnly);

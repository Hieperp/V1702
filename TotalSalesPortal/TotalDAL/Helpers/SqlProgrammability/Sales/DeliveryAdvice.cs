...
namespace TotalDAL.Helpers.SqlProgrammability.Sales
{
    public class DeliveryAdvice
    {
        ...
        private void GetDeliveryAdvicePendingSalesOrders()
        {
            ...
            queryString = queryString + "       SELECT          SalesOrders.SalesOrderID, SalesOrders.Reference AS SalesOrderReference, SalesOrders.Code AS SalesOrderCode, SalesOrders.EntryDate AS SalesOrderEntryDate, SalesOrders.PriceCategoryID, PriceCategories.Code AS PriceCategoryCode, SalesOrders.WarehouseID, Warehouses.Code AS WarehouseCode, Warehouses.Name AS WarehouseName, SalesOrders.VATPercent, SalesOrders.PaymentTermID, SalesOrders.SalespersonID, Employees.Name AS SalespersonName, SalesOrders.Description, SalesOrders.Remarks, " + "\r\n";
        ...
        private void GetDeliveryAdvicePendingSalesOrderDetails()
        {
            ...
            queryString = " @LocationID Int, @DeliveryAdviceID Int, @SalesOrderID Int, @CustomerID Int, @ReceiverID Int, @PriceCategoryID Int, @WarehouseID Int, @ShippingAddress nvarchar(200), @VATPercent decimal(18, 2), @EntryDate DateTime, @SalesOrderDetailIDs varchar(3999), @IsReadonly bit " + "\r\n";
            queryString = queryString + " WITH ENCRYPTION " + "\r\n";
            queryString = queryString + " AS " + "\r\n";

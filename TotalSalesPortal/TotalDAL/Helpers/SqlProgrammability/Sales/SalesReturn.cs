...
namespace TotalDAL.Helpers.SqlProgrammability.Sales
{
    public class SalesReturn
    {
        ...
        private void GetSalesReturnPendingGoodsIssues()
        {
            ...
            queryString = queryString + "       SELECT          GoodsIssueID, Reference AS GoodsIssueReference, EntryDate AS GoodsIssueEntryDate, DeliveryAdviceReferences, N'' AS CustomerCode, N'' AS CustomerName, ShippingAddress, Description, VATPercent, TotalQuantity, TotalFreeQuantity, TotalGrossAmount " + "\r\n";

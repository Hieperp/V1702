...
namespace TotalDAL.Helpers.SqlProgrammability.Sales
{
    public class SalesReturn
    {
        ...
        private void GetSalesReturnIndexes()
        {
            ...
            queryString = queryString + "       SELECT      SalesReturns.SalesReturnID, CAST(SalesReturns.EntryDate AS DATE) AS EntryDate, SalesReturns.Reference, Locations.Code AS LocationCode, Customers.Name AS CustomerName, CASE WHEN SalesReturns.CustomerID = SalesReturns.ReceiverID THEN '' ELSE Receivers.Name + ', ' END + SalesReturns.ShippingAddress AS ReceiverDescription, SalesReturns.Description, SalesReturns.TotalQuantity, SalesReturns.TotalQuantityReceived, SalesReturns.TotalFreeQuantity, SalesReturns.TotalFreeQuantityReceived, SalesReturns.TotalListedGrossAmount, SalesReturns.TotalGrossAmount, SalesReturns.Approved " + "\r\n";

...
namespace TotalDAL.Helpers.SqlProgrammability.Accounts
{
    public class Receipt
    {
        ...
        private void GetReceiptIndexes()
        {
            ...
            queryString = queryString + "                   ReceiptTypes.Code AS ReceiptTypeCode, MonetaryAccounts.Code AS MonetaryAccountCode, AdvanceReceipts.Reference AS AdvanceReceiptReference, AdvanceReceipts.EntryDate AS AdvanceReceiptDate, SalesReturns.Reference AS SalesReturnReference, SalesReturns.EntryDate AS SalesReturnDate, CreditNotes.Reference AS CreditNoteReference, CreditNotes.EntryDate AS CreditNoteDate, " + "\r\n";

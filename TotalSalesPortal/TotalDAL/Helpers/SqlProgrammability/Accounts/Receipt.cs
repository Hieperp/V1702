...
namespace TotalDAL.Helpers.SqlProgrammability.Accounts
{
    public class Receipt
    {
        ...
        private void GetGoodsIssueReceivables()
        {
            ...
            queryString = queryString + " WITH ENCRYPTION " + "\r\n";
            queryString = queryString + " AS " + "\r\n";
            queryString = queryString + "       SELECT          TOP 200 GoodsIssues.GoodsIssueID, GoodsIssues.Reference AS GoodsIssueReference, GoodsIssues.EntryDate AS GoodsIssueEntryDate, GoodsIssues.TotalGrossAmount, ROUND(GoodsIssues.TotalGrossAmount - GoodsIssues.TotalReceiptAmount - GoodsIssues.TotalCashDiscount - GoodsIssues.TotalOtherDiscount, " + (int)GlobalEnums.rndAmount + ") AS AmountDue, GoodsIssues.Description, GoodsIssues.Remarks, " + "\r\n";
